...
void mainImage(out vec4 o, vec2 C) {
  ...
  vec2 c0 = sceneC(C, r);
  C = c0;
  vec2 rr = vec2(0.0035); // Fast constant pixel width approximation to bypass heavy finite-difference calculations
...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      dpr: dpr ?? (typeof window !== 'undefined' ? Math.min(1.0, window.devicePixelRatio || 1) : 1),
      alpha: true,
      antialias: false
    });
